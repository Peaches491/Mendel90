...
// Extra extension of the hotend out the bottom (to clear x carriage)
hotend_extension=9;
  ...
  difference ()
  {
    union()
    {
      ...
      translate([large_wheel_translation[0]-filament_feed_hole_offset,
        ...
        rotate([-90,0,180]) {
          intersection() {
            cylinder(d=35, h=hotend_extension, center=false);
            translate([0, 2, 0]) {
              cube([50, 24, 2*hotend_extension + 30], center=true);
            }
          }
        }
      }
    ...
    translate([large_wheel_translation[0]-filament_feed_hole_offset,
        -base_thickness/2 - hotend_extension,wade_block_depth/2]){
      rotate([-90,0,0]) {
...
module block_holes(mounting_holes=default_mounting_holes)
{
  ...
  translate(large_wheel_translation)
  {
    ...
    translate([-filament_feed_hole_offset,0,wade_block_depth/2])
      ...
      cylinder(r=filament_feed_hole_d*1.1/2,
          h=wade_block_depth*3+elevation+50+2*hotend_extension,
          center=true,$fn=16);
